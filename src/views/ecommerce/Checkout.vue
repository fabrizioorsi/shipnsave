						...
						<div>
							<v-layout row wrap>
								<v-flex xs12 sm12 md12 >
									<v-text-field prepend-icon="perm_identity" label="Contact name" required></v-text-field>
								</v-flex>
							</v-layout>
							<v-layout row wrap>                   
								<v-flex xs12 sm12 md12>
									<v-text-field prepend-icon="perm_identity" label="Company name" required></v-text-field>
								</v-flex>
							</v-layout>
							<v-layout row wrap>
							...
							<v-layout row wrap>
								...
								<v-flex xs12 sm4 md4>
									<v-text-field prepend-icon="location_city" label="Province/State"></v-text-field>
								</v-flex>
								<v-flex xs12 sm4 md4>
							...
							<v-layout row wrap>
								<v-flex xs12 sm12 md12 xl12 lg12 mb-4>
									<v-checkbox v-model="addressCheck" label="Confirm Delivery" value=""></v-checkbox>
								</v-flex>
							</v-layout>	
							<v-layout row wrap>
								<v-flex xs12 sm12 md12 xl12 lg12 mb-4 class="col-height-auto">
									<v-checkbox label="Save as my default address" value=""></v-checkbox>
